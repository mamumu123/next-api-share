...
export function generateHairLines0(faceCountour: any[], numHairLines = 100) {
...
export function generateHairLines1(faceCountour: any[], numHairLines = 100) {
  var faceCountourCopy = faceCountour.slice(0, faceCountour.length - 2);
  var results = [];
  for (var i = 0; i < numHairLines; i++) {
    var numHairPoints = 20 + Math.floor(randomFromInterval(-5, 5));
...
export function generateHairLines2(faceCountour: any[], numHairLines = 100) {
...
export function generateHairLines3(faceCountour: any[], numHairLines = 100) {
  var faceCountourCopy = faceCountour.slice(0, faceCountour.length - 2);
  var results = [];
  var pickedIndices = [];
  for (var i = 0; i < numHairLines; i++) {
